...
const SubmitCVForm = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      // form.append('preferred_job_title', values.preferredJobTitle);
      // form.append('referred_by', values.knowledgeReference);
      // form.append('cv', values.cv);

      // const url = `https://apexrecruiterltd.com/backend/application.php`;
  ...
  return (
    <form
      ...
      action='backend/application.php'
      ref={form}
      method='POST'
